...
class _CartItemTile extends StatelessWidget {
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      _buildActionBtn(Icons.remove, onDecrement, accent),
                      Padding(
                      ...
                      _buildActionBtn(Icons.add, onIncrement, accent),
                      Container(
                        height: 20,
                        width: 1,
  ...
  Widget _buildActionBtn(IconData icon, VoidCallback onTap, Color accent) {
    return IconButton(
